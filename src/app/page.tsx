      ...
      <section className="about" id="about">
        <div className="container">
          <div className="about-copy" data-reveal>
            <p>
              I&apos;m a full-stack AI product engineer with a business background, holding finance and information systems degrees from Indiana University&apos;s Kelley School of Business and <span style={{color:"#65A8E3"}}>twelve years</span> building software at PwC, Capital One, and McKinsey. Most recently I led a <span style={{color:"#65A8E3"}}>team of 10</span> building an AI-powered performance evaluation platform used by McKinsey&apos;s senior partners.
            </p>
            <p>
